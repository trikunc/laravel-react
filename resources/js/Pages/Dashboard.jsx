                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 bg-white border-b border-gray-200">
                            ...
                            <input type="text" placeholder="Judul" className="input m-2 input-bordered w-full" onChange={(e) => setTitle(e.target.value)} value={title} />
                            <input type="text" placeholder="Diskripsi" className="input m-2 input-bordered w-full" onChange={(e) => setDescription(e.target.value)} value={description} />
                            <input type="text" placeholder="Kategori" className="input m-2 input-bordered w-full" onChange={(e) => setCategory(e.target.value)} value={category} />
